...
export class GenAccountTables1657841288015 implements MigrationInterface {
    name = 'GenAccountTables1657841288015'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "bank_accounts" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "account_name" character varying, "account_reference" character varying, "current_balance" double precision NOT NULL DEFAULT '0', "archived" boolean NOT NULL DEFAULT false, "deleted" boolean NOT NULL DEFAULT false, "date_created" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "last_updated" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "date_deleted" TIMESTAMP WITH TIME ZONE, "created_by" uuid NOT NULL, "last_updated_by" uuid, CONSTRAINT "PK_c872de764f2038224a013ff25ed" PRIMARY KEY ("id"))`);
